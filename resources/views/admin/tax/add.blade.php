        ...
        <div class="page-content">
            <div class="transition-all duration-150 container-fluid" id="page_layout">
                <div id="content_layout">
                    ...
                    <!-- END: BreadCrumb -->
                    <form action="{{ route('admin.taxation.store') }}" method="post" enctype="multipart/form-data"
                                            ...
                                            <div>
                                                ...
                                                <div class="input-area mb-4">
                                                    ...
                                                    <input name="vat_tax" type="number" class="form-control"
                                                        placeholder="e.g. 10" value={{ old('vat_tax') }} required>
                                                ...
                                                <div class="input-area mb-4">
                                                    ...
                                                    <input name="country" type="text" class="form-control"
                                                        placeholder="Germany" value="{{ old('country') }}" required ="required">
                                                    @if (session()->has('country_error'))
                                                        @error('country')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="input-area mb-4">
                                                    ...
                                                    <input name="short_code" type="text" class="form-control"
                                                        placeholder="DE" value="{{ old('short_code') }}" required ="required">
                                                    @if (session()->has('country_error'))
                                                        @error('short_code')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
