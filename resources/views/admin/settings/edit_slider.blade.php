                        ...
                        @csrf
                          ...
                          <div class="input-area mb-4">
                            ...
                            <div class="input-area mb-4">
                                <div class="filegroup">
                                    <label>
                                        <input name="slider" type="file" class=" w-full hidden" name="basic">
                            ...
                            <div class="input-area mb-4 flex items-center justify-between">
                                ...
                                <div>
                                    @if(@$slider->desktop)
                                        <img width="250" src="{{asset('root/public/uploads/sliders/desktop/'.$slider->slider)}}" />
                                    @elseif($slider->phone)
                                        <img width="250" src="{{asset('root/public/uploads/sliders/phone/'.$slider->slider)}}" />
                                    @endif
