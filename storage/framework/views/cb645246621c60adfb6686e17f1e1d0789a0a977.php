...
<div class="ps-product__content text-center">
    ...
    <div class="ps-product__actions ps-product__group-mobile d-block">
        <div class="ps-product__cart d-block">
            <?php if($product->type !='variable'): ?>
            <div class="add_to_cart_box"><a class="btn cart_btn d-block p-2" href="javascript:void(0)" onclick="add_to_cart('<?php echo e($product->id); ?>')">Add to cart</a>
            </div>
        <?php else: ?>
        <div class="add_to_cart_box ">
                <a onclick="addSimiliarProductId(<?php echo e($product->id); ?>)" class="btn cart_btn d-block p-2" href="<?php echo e(route('product.detail',[$category,$product->slug] )); ?>">View</a>
            </div>
        <?php endif; ?>
        </div>
    </div>
