      ...
      <ul class="list space-y-8">
        ...
        <li class="flex space-x-3 rtl:space-x-reverse">
          ...
          <div class="flex-1">
            ...
            <a href="#" class="text-base text-slate-600 dark:text-slate-50">
             <?php echo e($attribute->attribute_type); ?>
        ...
        <li class="flex space-x-3 rtl:space-x-reverse">
          ...
          <div class="flex-1">
            ...
            <a href="#" class="text-base text-slate-600 dark:text-slate-50">
              <?php echo e($attribute->attribute_description); ?>
...
<?php echo $__env->make('admin.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customstegpearl/public_html/root/resources/views/admin/productAttributes/view.blade.php ENDPATH**/ ?>