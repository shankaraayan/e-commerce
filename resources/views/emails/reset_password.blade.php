...
@endphp
  ...
  <body class="o_body o_bg-light" style="width: 100%;margin: 0px;padding: 0px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #f3f3f3;">
    ...
    <!-- header-white-link -->
     @include('emails.elements.new_header')
    <!-- hero-icon-lines -->
    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
      <tbody>
        <tr>
                      ...
                      <tbody>
                        <tr>
                          <td width="300" class="o_btn o_bg-primary o_br o_heading o_text" align="center" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;mso-padding-alt: 12px 24px;background-color: black;border-radius: 4px;">
                            <a class="o_text-white" href="{{url($data)}}" style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">Passwort  zurücksetzen</a>
                          </td>
                        </tr>
                      </tbody>
                    </table>
    ...
    <!-- footer-white-2cols -->
    @include('emails.elements.new_footer')
    </body>
</html>
