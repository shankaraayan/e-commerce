                        ...
                        <?php echo csrf_field(); ?>
                          ...
                          <div class="input-area mb-4">
                            ...
                            <div class="input-area mb-4">
                                ...
                                <div class="flex items-center space-x-7 flex-wrap">
                                    <?php if( @$slider->desktop): ?>
                                        <div class="primary-radio">
                                                <label class="flex items-center cursor-pointer">
                                                    <input type="radio" class="hidden" name="screen" disabled value="desktop" checked="<?php echo e(@$slider->desktop ? true : false); ?>" />
                                    ...
                                    <?php else: ?>
                                        <div class="primary-radio">
                                            <label class="flex items-center cursor-pointer">
                                                <input type="radio" class="hidden" name="screen" value="phone" disabled checked="<?php echo e(@$slider->phone ? true : false); ?>" />
                                                <span class="flex-none bg-white dark:bg-slate-500 rounded-full border inline-flex ltr:mr-2 rtl:ml-2 relative transition-all duration-150 h-[16px] w-[16px] border-slate-400 dark:border-slate-600 dark:ring-slate-700"></span>
                            ...
                            <div class="input-area mb-4 flex items-center justify-between">
                                ...
                                <div>
                                    <?php if(@$slider->desktop): ?>
                                        <img width="250" src="<?php echo e(asset('root/public/uploads/sliders/desktop/'.$slider->slider)); ?>" />
                                    <?php elseif($slider->phone): ?>
                                        <img width="250" src="<?php echo e(asset('root/public/uploads/sliders/phone/'.$slider->slider)); ?>" />
                                    <?php endif; ?>
