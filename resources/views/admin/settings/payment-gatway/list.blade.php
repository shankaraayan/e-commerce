                ...
                <!--//* BEGIN: Breadcrumb -->
                    ...
                    <div class="card">
                        <header class=" card-header noborder">
                            ...
                            <a href="{{route('admin.settings.payment-gatway.add')}}"> <button type="button" class="btn bg-slate-800 text-white" style="float:right;"> Add New Payment Method </button></a>
                        </header>
                                    ...
                                    <div class="overflow-hidden ">
                                        <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700 data-table">
                                            ...
                                            <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                                @foreach($paymentGatway as $key=>$gatway)
                                                ...
                                                <a href="{{route('admin.settings.slider.edit_slider',$gatway->id)}}">
                                                    ...
                                                    <a  onclick="return confirm('Are you sure. you want to delete?')" href="{{route('admin.settings.payment-gatway.delete',$gatway->id)}}">
                                                    <button class="action-btn" type="button">
