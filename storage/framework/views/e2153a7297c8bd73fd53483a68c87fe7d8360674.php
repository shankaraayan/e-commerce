                  ...
                  <div class="card">
                    <div class="card-body flex flex-col p-6">
                      ...
                      <div class="card-text h-full space-y-4">
                        <form action="<?php echo e(route('admin.settings.slider.upload')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customstegpearl/public_html/root/resources/views/admin/settings/add_slider.blade.php ENDPATH**/ ?>