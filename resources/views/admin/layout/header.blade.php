...
<head>
    ...
    <!-- BEGIN: Theme CSS-->
    <link rel="stylesheet" href="{{ asset('admin_assets/css/rt-plugins.css') }}">
...
<body class=" font-inter dashcode-app" id="body_class">
    <main class="app-wrapper">
      ...
      inline-flex items-center"
                                ...
                                <span
                                    class="flex-none text-slate-600 dark:text-white text-sm font-normal items-center lg:flex hidden overflow-hidden text-ellipsis whitespace-nowrap">{{ ucfirst(auth()->user()->firstname) }}
