          ...
          <div class="p-6 space-y-4">
                <div class="input-area mb-4">
                    ...
                    <select  name="selected_attribute_type"  class="form-control selected_attribute_type">
                        ...
                        <?php $__currentLoopData = $attributeTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($value->id); ?>" class="dark:bg-slate-700"><?php echo e($value->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="input-area mb-4">
...
<script>
    $(document).ready(function(){
        ...
        document.getElementById("updateButton").addEventListener("click", function(event) {
            ...
            $.ajax({
                url : '<?php echo e(route("admin.product.attribute.type.update")); ?>',
                type : 'POST',
                data : formData,
                processData : false,
                contentType : false,
        ...
        $(".del-btn").on('click',function(){
            ...
            if(con){
                 $.ajax({
                url : '<?php echo e(route("admin.product.attribute.type.delete")); ?>',
                type : 'POST',
                data : {
        ...
        document.getElementById("createButton").addEventListener("click", function(event) {
          event.preventDefault();
            ...
            const formData = new FormData(document.getElementById("attribute_type_form"));
                // console.log("hellooo");
                    $.ajax({
                        url : '<?php echo e(route("admin.product.attribute.type.create")); ?>',
                        type : 'POST',
                        data : formData,
                        processData : false,
                        contentType : false,
...
<?php echo $__env->make('admin.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customstegpearl/public_html/root/resources/views/admin/productAttributes/add.blade.php ENDPATH**/ ?>