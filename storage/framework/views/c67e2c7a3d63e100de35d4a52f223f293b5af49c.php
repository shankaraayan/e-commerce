            ...
            <div class="row product-container">
                <div class="col-12 col-xl-5 col-md-5 product-image">
                    ...
                    <div class="main-image owl-carousel owl-loaded owl-drag" data-owl-loop="true" data-owl-auto="false" data-owl-nav="false" data-owl-dots="false">
                        <div class="item">
                          <img src="<?php echo e(asset('root/public/uploads/' . $product->thumb_image)); ?>" alt="Epp Solar" />
                        </div>
                        <?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item">
                          <img src="<?php echo e(asset('root/public/uploads/' . $image->images)); ?>" alt="Epp Solar" />
                        </div>
                        ...
                        <div class="item">
                        <img src="<?php echo e(asset('root/public/uploads/' . $product->thumb_image)); ?>" alt="Epp Solar" data-index="0" />
                        </div>
                        <?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item">
                        <img src="<?php echo e(asset('root/public/uploads/' . $image->images)); ?>" alt="Epp Solar"
                                    ...
                                    <div class="form-check col-12 mb-4">
                                        ...
                                        <label class="form-check-label mx-2" for="var_radios<?php echo e($key); ?>_<?php echo e($keyss); ?>">
                                          <div class="row align-items-center select_var_row p-2 term-select-<?php echo e($vales->id); ?>">
                                              ...
                                              <img src="<?php echo e(asset('root/public/uploads/'.$vales->image)); ?>" alt="Epp Solar" class="img-fluid">
                                              </div>
                                              <?php endif; ?>
