                                  ...
                                  <div class="p-6 space-y-4">
                                        ...
                                        <div class="input-area mb-4">
                                            <label class="relative inline-flex h-6 w-[46px] items-center rounded-full transition-all duration-150 cursor-pointer">
                                                <input onclick="(this.checked ? this.value=1 : this.value=0)" attribute_id="<?php echo e($values->id); ?>" name="status" value="<?php echo e($values->status); ?>" type="checkbox" <?php echo e($values->status ==1 ? 'checked':'uncheked'); ?>  class="sr-only peer attribute_status">
