...
<div class="ps-shopping__content bg-light pt-20">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h3 class="ps-shopping__title">Einkaufskorb<sup class="text-green fs-1"></sup></h3>
            </div>
                            ...
                            <?php else: ?>
                                <li>
                                    <div class="ps-product ps-product--wishlist">
                                        ...
                                        <div class="ps-product__content">
                                            <h5 class="ps-product__title d-block text-left">
                                                <a href="<?php echo e(route('product.detail', @$details['slug'])); ?>"><span class="cart_producttitle"><?php echo e(@$details['name']); ?></span></a>
                                            </h5>
                                            <div class="ps-product__row">
                                                <div class="ps-product__label">Price:</div>
                                                <div class="ps-product__value"><span
                        ...
                        <div class="container">
                            ...
                            <?php if(session('cart')): ?>
                                <?php $__currentLoopData = session('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if($details['type'] == 'variable'): ?>
                                        <div class="row variable_table mb-3 border p-3">
                                          <div class="col-md-2">
                                                    ...
                                                    <?php if(!empty(@$details['details'])): ?>
                                                     <div class="card card-body border-0 p-1 mt-1">
                                                        ...
                                                        <?php if($detailsCount > 2): ?>
                                                            ...
                                                            <a class="btn shadow-none fs-5 font-weight-bold pl-0 cartcomponent_btn" data-toggle="collapse" href="#attribute_values<?php echo e($id); ?>" role="button" aria-expanded="false" aria-controls="attribute_values">View more</a>
                                                        <?php endif; ?>
                                                     </div>
                                                    <?php endif; ?>
                                    ...
                                    <?php else: ?>
                                        <div class="row single_product mb-3 border p-3 justify-content-start ">
                                            <div class="col-md-2">
                                              <div class="cartproduct__thumbnail"><a class="cartproduct__image" href="<?php echo e(route('product.detail', @$details['slug'])); ?>">
                                            ...
                                            <div class="col-md-9">
                                                <div class="ps-product__name">
                                                    <div class="cart_product_name">
                                                        <a class="cart_producttitle" href="<?php echo e(route('product.detail', @$details['slug'])); ?>"><span class="mb-2 d-block cart_producttitle ps-product__title"><?php echo e(@$details['name']); ?></span></a>
                                                    </div>
