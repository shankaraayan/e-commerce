                ...
                <div class="mb-5">
                  <ul class="m-0 p-0 list-none">
                   ...
                   <a href="<?php echo e(route('admin')); ?>"> <li class="inline-block relative text-sm text-primary-500 font-Inter ">
                    ...
                    <a href="<?php echo e(route('admin.shipping.list')); ?>"> <li class="inline-block relative text-sm text-primary-500 font-Inter ">
                      Shipping
                      <iconify-icon icon="heroicons-outline:chevron-right" class="relative top-[3px] text-slate-500 rtl:rotate-180"></iconify-icon>
                    </li></a>

                    <li class="inline-block relative text-sm text-slate-500 font-Inter dark:text-white">
                      Add Country Shipping</li>
                  </ul>
                </div>
                <!-- END: BreadCrumb -->
                  ...
                  <div class="card">
                    <div class="card-body flex flex-col p-6">
                      ...
                      <div class="card-text h-full space-y-4">
                        <form action="<?php echo e(route('admin.shipping.country.store')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customstegpearl/public_html/root/resources/views/admin/shipping/countryShipping/add.blade.php ENDPATH**/ ?>