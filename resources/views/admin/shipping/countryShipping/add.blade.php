                ...
                <div class="mb-5">
                  <ul class="m-0 p-0 list-none">
                   ...
                   <a href="{{route('admin')}}"> <li class="inline-block relative text-sm text-primary-500 font-Inter ">
                    ...
                    <a href="{{route('admin.shipping.list')}}"> <li class="inline-block relative text-sm text-primary-500 font-Inter ">
                      Shipping
                      <iconify-icon icon="heroicons-outline:chevron-right" class="relative top-[3px] text-slate-500 rtl:rotate-180"></iconify-icon>
                    </li></a>
                  ...
                  <div class="card">
                    <div class="card-body flex flex-col p-6">
                      ...
                      <div class="card-text h-full space-y-4">
                        <form action="{{route('admin.shipping.country.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
