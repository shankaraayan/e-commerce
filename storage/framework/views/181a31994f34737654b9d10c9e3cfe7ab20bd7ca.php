            ...
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-4">
                                    <div class="ps-footer--address">
                                        <div class="ps-logo"><a href="<?php echo e(route('homepage')); ?>"> <img
                                                    src="<?php echo e(asset('assets/img/stegpearl/Stegpearl-de-white.png')); ?>"
                                                    alt></a></div>
                                ...
                                <div class="col-12 col-md-8">
                                    <div class="ps-footer--contact">
                                        ...
                                        <div class="ps-footer__fax"><i class="icon-telephone"></i><a
                                                href="tel:4904042308603">49 (0) 40 4230 8603</a></div>
                ...
                <div class="ps-footer--bottom">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 text-right"><img src="<?php echo e(asset('assets/img/payment.png')); ?>" alt><img
                                class="payment-light" src="<?php echo e(asset('assets/img/payment-light.png')); ?>" alt></div>
                    </div>
                </div>
            </div>
        </footer><?php /**PATH /home/customstegpearl/public_html/root/resources/views/Layout/footer.blade.php ENDPATH**/ ?>