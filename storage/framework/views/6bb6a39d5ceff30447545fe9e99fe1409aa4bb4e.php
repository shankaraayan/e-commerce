...
<div class="dashboard_content">
    <a href="/logout"> </a>
    <p>Hello <a href="<?php echo e(route('user.dashboard')); ?>"> <b><?php echo e(Auth::user()->name); ?></b> </a> <span class="small">(nicht <?php echo e(Auth::user()->name); ?> ? <a class="text-danger" href="<?php echo e(route('logout')); ?>">logout</a>)</span></p>
