          ...
          <div class=" space-y-5">
            ...
            <div class="card">
              <header class=" card-header noborder">
                ...
                <a href="<?php echo e(route('admin.shipping.country.add',$id)); ?>"> <button type="button" class="btn bg-slate-800 text-white" style="float:right;"> Add Shipping </button></a>
              </header>
                  ...
                  <div class="inline-block min-w-full align-middle">
                    <div class="overflow-hidden ">
                      <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700 data-table">
                        ...
                        <?php $__currentLoopData = $countryShipping; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                            ...
                            <td class="table-td ">
                              <div class="flex space-x-3 rtl:space-x-reverse">
                                ...
                                <a href="<?php echo e(route('admin.shipping.country.delete',$values->id)); ?>">
                              ...
                              rounded-md outline-none text-current">
                                <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                                  ...
                                  <div class="flex items-center justify-end p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                                    <button type="submit" data-bs-dismiss="modal" class="btn inline-flex justify-center bg-black-900 text-white">Update</button>
                                  </div>
                                </div>
                              </div>
                            </div>
...
<?php echo $__env->make('admin.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customstegpearl/public_html/root/resources/views/admin/shipping/countryShipping/list.blade.php ENDPATH**/ ?>