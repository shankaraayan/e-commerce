                                                    ...
                                                    @if (!empty(@$details['details']))
                                                     <div class="card card-body border-0 p-1 mt-1">
                                                        ...
                                                        @if ($detailsCount > 2)
                                                            ...
                                                            <a class="btn shadow-none fs-5 font-weight-bold pl-0 cartcomponent_btn" data-toggle="collapse" href="#attribute_values{{$id}}" role="button" aria-expanded="false" aria-controls="attribute_values">View more</a>
                                                        @endif
                                                     </div>
                                                    @endif
