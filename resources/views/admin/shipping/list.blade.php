          ...
          <div class=" space-y-5">
            ...
            <div class="card">
              <header class=" card-header noborder">
                ...
                <a href="{{route('admin.shipping.add')}}"> <button type="button" class="btn bg-slate-800 text-white" style="float:right;"> Add Shipping </button></a>
              </header>
                  ...
                  <div class="inline-block min-w-full align-middle">
                    <div class="overflow-hidden ">
                      <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700 data-table">
                        ...
                        @foreach($shipping as $key=>$values)
                          <tr>
                            ...
                            <td class="table-td ">
                              <div class="flex space-x-3 rtl:space-x-reverse">
                                ...
                                <a href="{{route('admin.shipping.delete',$values->id)}}">
