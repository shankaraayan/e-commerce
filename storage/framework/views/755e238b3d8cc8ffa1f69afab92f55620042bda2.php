    ...
    <main class="app-wrapper">
                ...
                <div class="flex justify-between items-center h-full">
                    <div class="flex items-center md:space-x-4 space-x-2 xl:space-x-0 rtl:space-x-reverse vertical-box">
                        <a href="index.html" class="mobile-logo xl:hidden inline-block">
                            <img src="https://i0.wp.com/campergold.net/wp-content/uploads/2023/02/CG_logo_white.png"
      ...
      inline-flex items-center"
                                ...
                                <div class="lg:h-8 lg:w-8 h-7 w-7 rounded-full flex-1 ltr:mr-[10px] rtl:ml-[10px]">
                                    <img src="https://www.thecakepalace.com.au/wp-content/uploads/2022/10/dummy-user-360x321.png"
                                        alt="user" class="block w-full h-full object-cover rounded-full">
                                </div>
                                <span
                                    class="flex-none text-slate-600 dark:text-white text-sm font-normal items-center lg:flex hidden overflow-hidden text-ellipsis whitespace-nowrap"><?php echo e(ucfirst(auth()->user()->firstname)); ?>

                                    <?php echo e(ucfirst(auth()->user()->lastname)); ?></span>
    ...
    backdrop-filter backdrop-blur-[40px] fixed left-0 bottom-0 w-full z-[9999] bothrefm-0 py-[12px] px-4 md:hidden">
      ...
      h-[65px] w-[65px] z-[-1] -mt-[40px] flex justify-center items-center">
                <div class="h-[50px] w-[50px] rounded-full relative left-[0px] hrefp-[0px] custom-dropshadow">
                    <img src="assets/images/users/user-1.jpg" alt="Epp Solar"
        ...
        var updatedPositions = [];
         ...
         for (var i = 1; i < rows.length; i++) {
            ...
            headers: {
                ...
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' // Include Laravel CSRF token
            },
