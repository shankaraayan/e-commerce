															...
															<td style="padding-top:10px;">
																<div style="font-family: sans-serif">
																	<div class="txtTinyMce-wrapper"
																		style="font-size: 12px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 18px; color: #ffffff; line-height: 1.5;">
																		<p
																			style="margin: 0; font-size: 14px; text-align: left;">Stegpearl<br />Danckwerthweg 25,<br />22119 Hamburg</p>
																	</div>
																</div>
															</td>
														</tr>
														...
														<tr>
															<td style="padding-top:10px; float: right;">
																<div
																	...
																	@if(!empty(@$data['order_data']['channel_id']))
															<br><a style="color: #fff;" href="{{FrontHelper::email_view_ticket_url(@$data['order_data']['channel_id'])}}" target="_blank"> Support Ticket</a>
															@endif
