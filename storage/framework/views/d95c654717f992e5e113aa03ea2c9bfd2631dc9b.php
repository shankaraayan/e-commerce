        ...
        <div class="page-content">
            <div class="transition-all duration-150 container-fluid" id="page_layout">
                <div id="content_layout">
                    ...
                    <!-- END: BreadCrumb -->
                    <form action="<?php echo e(route('admin.taxation.update')); ?>" method="post" enctype="multipart/form-data"
                        id="multipleValidation">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="id" value="<?php echo e($taxation->id); ?>">
                                            ...
                                            <div>
                                                <div class="input-area mb-4">
                                                    ...
                                                    <input name="vat_tax" type="number" class="form-control"
                                                        placeholder="e.g. 10" value=<?php echo e($taxation->vat_tax); ?> required>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="input-area mb-4">
                                                    ...
                                                    <input name="country" type="text" class="form-control"
                                                        placeholder="Germany" value="<?php echo e($taxation->country); ?>" required ="required">
                                                    <?php if(session()->has('country_error')): ?>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="input-area mb-4">
                                                    ...
                                                    <input name="short_code" type="text" class="form-control"
                                                        placeholder="DE" value="<?php echo e($taxation->short_code); ?>" required ="required">
                                                    <?php if(session()->has('country_error')): ?>
...
<?php echo $__env->make('admin.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customstegpearl/public_html/root/resources/views/admin/tax/edit.blade.php ENDPATH**/ ?>