                        ...
                        @csrf
                          ...
                          <div class="input-area mb-4">
                                ...
                                <select id="select" name="status" class="form-control" required>
                                        @if(@$slider->status)
                                            <option value="{{ @$slider->status}}" selected class="dark:bg-slate-700">Active</option>
                                            <option value="0" class="dark:bg-slate-700">InActive</option>
                                        @else
                                            <option value="{{ @$slider->status}}" class="dark:bg-slate-700">InActive</option>
                            ...
                            <div class="input-area mb-4">
                                ...
                                <div class="flex items-center space-x-7 flex-wrap">
                                    {{-- @if( @$slider->desktop)
                                        <div class="primary-radio">
                                                <label class="flex items-center cursor-pointer">
                                                    <input type="radio" class="hidden" name="screen" disabled value="desktop" checked="{{ @$slider->desktop ? true : false }}" />
                                    ...
                                    @elseif(@$slider->phone)
                                        <div class="primary-radio">
                                            <label class="flex items-center cursor-pointer">
                                                <input type="radio" class="hidden" name="screen" value="phone" disabled checked="{{ @$slider->phone ? true : false }}" />
                                                <span class="flex-none bg-white dark:bg-slate-500 rounded-full border inline-flex ltr:mr-2 rtl:ml-2 relative transition-all duration-150 h-[16px] w-[16px] border-slate-400 dark:border-slate-600 dark:ring-slate-700"></span>
                                      ...
                                      <div class="primary-radio">
                                        <label class="flex items-center cursor-pointer">
                                            <input type="radio" class="hidden" name="screen" value="global_banner"  {{ @$slider->global_banner =='1' ? 'checked' : '' }} />
                                            <span class="flex-none bg-white dark:bg-slate-500 rounded-full border inline-flex ltr:mr-2 rtl:ml-2 relative transition-all duration-150 h-[16px] w-[16px] border-slate-400 dark:border-slate-600 dark:ring-slate-700"></span>
                            ...
                            <div class="input-area mb-4 flex items-center justify-between">
                                ...
                                <div>
                                    Desktop : 
                                        <img width="250" src="{{asset('root/public/uploads/sliders/desktop/'.$slider->desktop)}}" />
                                        <br>
                                    Phone : 
                                        <img width="250" src="{{asset('root/public/uploads/sliders/phone/'.$slider->phone)}}" />
