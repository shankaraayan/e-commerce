          ...
          <div class="page-content">
            <div class="transition-all duration-150 container-fluid" id="page_layout">
              <div id="content_layout">
                ...
                <!-- END: BreadCrumb -->
                <form action="<?php echo e(route('admin.coupon.update',$coupon->id)); ?>" method="post" enctype="multipart/form-data" id="multipleValidation">
                    <?php echo csrf_field(); ?>
                                            ...
                                            <div class="card-text h-full space-y-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="input-area mb-4">
                                                        ...
                                                        <input id="code" value="<?php echo e($coupon->code); ?>" disabled name="code" type="text" class="form-control" placeholder="Auto Genrated" required>
                                                    </div>
                                                    <div class="input-area mb-4">
                                                        ...
                                                        <select name="appliable_on" class="form-control w-full mt-2">
                                                            ...
                                                            <option value="flat" class="py-1 inline-block font-Inter font-normal text-sm text-slate-600" <?php echo e(@$coupon->appliable_on === 'flat' ? 'selected' : ''); ?>>Flat discount</option>
                                                            <option value="Percentage" class="py-1 inline-block font-Inter font-normal text-sm text-slate-600" <?php echo e(@$coupon->appliable_on === 'Percentage' ? 'selected' : ''); ?>>Percentage</option>
                                                        </select>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="input-area mb-4">
                                                        ...
                                                        <input value="<?php echo e($coupon->price); ?>"  name="price" type="number" class="form-control" placeholder="e.g. 10" value=<?php echo e(old('price')); ?>>
                                                        <?php if(session()->has('coupan_code_errore')): ?>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="input-area mb-4">
                                                        ...
                                                        <select name="limit_use" class="form-control w-full mt-2">
                                                            ...
                                                            <option value="single" class="py-1 inline-block font-Inter font-normal text-sm text-slate-600" <?php echo e(@$coupon->limit_use === 'single' ? 'selected' : ''); ?>>Single Use</option>
                                                            <option value="multiuse" class="py-1 inline-block font-Inter font-normal text-sm text-slate-600" <?php echo e(@$coupon->limit_use === 'multiuse' ? 'selected' : ''); ?>>Multi Use</option>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="input-area mb-4">
                                                        ...
                                                        <input id="min_order" name="min_order" type="text" class="form-control" placeholder="Min order value" value=<?php echo e(@$coupon->min_order); ?>>
                                                        <?php if(session()->has('coupan_code_errore')): ?>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="input-area mb-4 ">
                                                        ...
                                                        <input name="expiry_date" class="form-control py-2 flatpickr flatpickr-input " id="default-picker" value="<?php echo e(@$coupon->expiry_date ?? old('expiry_date')); ?>" type="date"  >
                                                    </div>
                                                    <div class="input-area mb-4">
                                                        <label for="status" class="form-label">Status</label>
                                                        <div class="flex items-center mr-2 sm:mr-4 mt-2 space-x-2">
                                                            <label class="relative inline-flex h-6 w-[46px] items-center rounded-full transition-all duration-150 cursor-pointer">
                                                            <input <?php echo e($coupon->status ==1 ? 'checked':'uncheked'); ?> name="status" value="<?php echo e(@$coupon->status); ?>"  type="checkbox"  class="sr-only peer">
                                        ...
                                        <div class="input-area mb-4">
                                            ...
                                            <select required name="applicable_country[]" id="country" class="select2 form-control w-full mt-2 py-2" multiple="multiple">
                                                ...
                                                <?php $__currentLoopData = $country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $con): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if((int)$con->id == (int)$id): ?>
                                                        <option selected value="<?php echo e($con->id); ?>" class="inline-block font-Inter font-normal text-sm text-slate-600" <?php echo e(in_array($con->id, old('country', [])) ? 'selected' : ''); ?>><?php echo e($con->country); ?></option>
                                                    <?php else: ?>
                                                        <option value="<?php echo e($con->id); ?>" class="inline-block font-Inter font-normal text-sm text-slate-600" <?php echo e(in_array($con->id, old('country', [])) ? 'selected' : ''); ?>><?php echo e($con->country); ?></option>
                                                    <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="input-area mb-4">
                                            ...
                                            <select name="specific_user" class="form-control w-full mt-2" id="specific_user">
                                                <option selected="Selected" disabled="disabled" value="none" class="py-1 inline-block font-Inter font-normal text-sm text-slate-600">Select an option</option>
                                                <option value="1" class="py-1 inline-block font-Inter font-normal text-sm text-slate-600" <?php echo e(@$coupon->specific_user === '1' ? 'selected' : ''); ?> >Yes</option>
                                                <option value="0" class="py-1 inline-block font-Inter font-normal text-sm text-slate-600" <?php echo e(@$coupon->specific_user === '0' ? 'selected' : ''); ?>>No</option>
                                            </select>
                                            <?php if(session()->has('coupan_code_errore')): ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="input-area mb-4">
                                            <div id="specific_user_option"  style="<?php echo e(!empty($coupon->user_id) ? 'display:block' : 'display:none'); ?>" >
                                                <label for="user_id" class="form-label">Users (coma "," Saperated)</label>
                                                <input type="text"   name="user_id" class="form-control" value="<?php echo e($coupon->user_id,old('userList')); ?>">
                                            </div>
                                        ...
                                        <div style="<?php echo e(!empty($coupon->exclude_category) ? 'display:block' : 'display:none'); ?>"  id="CategorytContaier" class="mb-8">
                                        ...
                                        <div style="<?php echo e(!empty($coupon->exclude_product) ? 'display:block' : 'display:none'); ?>" id="productContaier" class="mb-8">
...
<?php echo $__env->make('admin.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customstegpearl/public_html/root/resources/views/admin/coupons/edit.blade.php ENDPATH**/ ?>