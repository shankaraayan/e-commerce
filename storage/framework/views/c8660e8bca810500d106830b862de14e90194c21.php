...
<?php $component->withAttributes(['value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('DisabledShortBy')),'filterIcon' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('d-none'))]); ?>agb <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<div class="container pb-30 pt-30">
    <div class="row">
        <div class="agb-content">
            <h2 class="mb-5">Allgemeine Geschäftsbedingungen</h2>
            <h3 class="mb-5"><strong>Wichtiger Hinweis:</strong><br></h3>
            <p class="mb-5">Gem. § 12 Abs. 3 Nr. 1 UStG kann bestimmte Ware mit einem Umsatzsteuersatz von 0 % verkauft
                werden, sofern die rechtlichen Voraussetzungen dieser Norm erfüllt sind.</p>
            <p class="mb-5">Sollten Sie einen Kaufvertrag über eine solche Ware mit einem ausgewiesenen Umsatzsteuersatz von
            ...
            <p class="mb-5"></p>
            <p class="mb-5">Da zu der neuen Gesetzeslage zu § 12 Abs. 3 Nr. 1 UStG noch keine gefestigte Verwaltungspraxis
            ...
            <h2 class="mb-5">1. Geltungsbereich</h2>
            <p class="mb-5">(1) Diese Allgemeinen Geschäftsbedingungen (im Folgenden: “AGB”) gelten für alle über unseren
            ...
            <h3 class="mb-5">2. Vertragsschluss</h3>
            <p class="mb-5">(1) Die Präsentation und Bewerbung von Artikeln in unserem Online-Shop stellt kein bindendes
            ...
            <h3 class="mb-5">3. Lieferbedingungen und Vorbehalt der Vorkassezahlung</h3>
            <p class="mb-5">(1) Wir sind zu Teillieferungen berechtigt, soweit dies für Sie zumutbar ist. <br>(2) Die
            ...
            <h3 class="mb-5">4. Preise und Versandkosten</h3>
            <p class="mb-5">(1) Sämtliche Preisangaben in unserem Online-Shop sind Bruttopreise inklusive der gesetzlichen
            ...
            <h3 class="mb-5">5. Zahlungsbedingungen und Aufrechnung und Zurückbehaltungsrecht</h3>
            <p class="mb-5">(1) Der Kaufpreis und die Versandkosten sind spätestens binnen zwei (2) Wochen ab Zugang unserer
            ...
            <h3 class="mb-5">6. Eigentumsvorbehalt</h3>
            <p class="mb-5">Die gelieferte Ware bleibt bis zur vollständigen Bezahlung des Kaufpreises in unserem Eigentum.
            </p>
            <h3 class="mb-5">7. Gewährleistung</h3>
            <p class="mb-5">(1) Wir haften für Sach- oder Rechtsmängel gelieferter Artikel nach den geltenden gesetzlichen
            ...
            <h3 class="mb-5">8. Haftung</h3>
            <p class="mb-5">(1) Wir haften Ihnen gegenüber in allen Fällen vertraglicher und außervertraglicher Haftung bei
            ...
            <h3 class="mb-5">9. Urheberrechte</h3>
            <p class="mb-5">Wir haben an allen Bildern, Filme und Texten, die in unserem Online Shop veröffentlicht werden,
                Urheberrechte. Eine Verwendung der Bilder, Filme und Texte, ist ohne unsere ausdrückliche
                Zustimmung nicht gestattet.</p>
            <h3 class="mb-5">10. Anwendbares Recht und Gerichtsstand</h3>
            <p class="mb-5"> (1) Es gilt das Recht der Bundesrepublik Deutschland unter Ausschluss des UN-Kaufrechts. Wenn Sie
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layout.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customstegpearl/public_html/root/resources/views/pages/agb.blade.php ENDPATH**/ ?>