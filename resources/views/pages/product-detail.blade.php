            ...
            <div class="col-12 col-xl-7 col-md-7 ">
                            ...
                            <div class="form-check col-12 mb-4">
                                ...
                                <div class="row select_var_row p-3 term-select-{{$vales->id}}">
                                    ...
                                    <h3 class="attribute_title_name py-2 d-flex justify-content-between">
                                        {{ $vales->attribute_term_name }} <small class="attribute_price">{{
                                        formatPrice($vales->price) }}</small>
                                    </h3>
                ...
                <div class="product_meta">
                    ...
                    <span class="sku_wrapper">Kategorien: <span
                        class="sku">{{categories()->where('id',$product->categories)->pluck('name')->first()}}</span></span>
                </div>
