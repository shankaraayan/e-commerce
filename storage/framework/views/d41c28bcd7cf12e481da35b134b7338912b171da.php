          ...
          <div class="page-content">
            <div class="transition-all duration-150 container-fluid" id="page_layout">
              <div id="content_layout">
                ...
                <!-- END: BreadCrumb -->
                <form action="<?php echo e(route('admin.settings.payment-gatway.update',$gatway->id)); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                      ...
                      <div class="card-text h-full space-y-4">
                            ...
                            <div class="input-area mb-5">
                                ...
                                <select id="select" name="status" class="form-control" required>
                                    <option value="1" class="dark:bg-slate-700" <?php if(@$gatway->status == '1'): ?> selected <?php endif; ?>>Active</option>
                                    <option value="0" class="dark:bg-slate-700" <?php if(@$gatway->status == '0'): ?> selected <?php endif; ?>>Inactive</option>
                                </select>
                            </div>
                            <div class="input-area mb-5">
                                <label for="select" class="form-label">Mode</label>
                                <select id="select" name="mode" class="form-control" required>
                                    <option value="0" class="dark:bg-slate-700" <?php if(@$gatway->mode == '0'): ?> selected <?php endif; ?>>Sandbox</option>
                                    <option value="1" class="dark:bg-slate-700" <?php if(@$gatway->mode == '1'): ?> selected <?php endif; ?>>Live</option>
                                </select>
                            </div>

                            <div class="input-area mb-4">
                                <label for="select" class="form-label">APP Name</label>
                                <input type="text" name="app_name" class="form-control" value="<?php echo e($gatway->app_name); ?>">
                            </div>
                            <div class="input-area mb-4">
                                <label for="select" class="form-label">APP ID</label>
                                <input type="text" name="app_id" class="form-control" value="<?php echo e($gatway->app_id); ?>">
                            </div>
                            <div class="input-area mb-4">
                                <label for="select" class="form-label">Currency</label>
                                <input type="text" name="PAYPAL_CURRENCY" class="form-control" value="<?php echo e($gatway->PAYPAL_CURRENCY); ?>">
                            </div>
                            ...
                            <div class="card-body flex flex-col p-6">
                                <div class="card-text h-full space-y-4 mb-4">
                                    <div class="input-area mb-4">
                                        ...
                                        <input type="text" name="client_id" class="form-control" value="<?php echo e($gatway->API_KEY); ?>">
                                    </div>
                                    <div class="input-area mb-4">
                                        <label for="select" class="form-label">Client Secret</label>
                                        <input type="password" name="secret" class="form-control" value="<?php echo e($gatway->API_SECRET); ?>">
                                    </div>
                                    <div class="input-area mb-4">
                                        <label for="select" class="form-label">Success Callback URL </label>
                                        <input type="text" name="PAYPAL_SUCCESS_URL" class="form-control" value="<?php echo e($gatway->PAYPAL_SUCCESS_URL); ?>">
                                    </div>
                                    <div class="input-area mb-4">
                                        <label for="select" class="form-label">Failed Callback URL </label>
                                        <input type="text" name="PAYPAL_FAILED_URL" class="form-control" value="<?php echo e($gatway->PAYPAL_FAILED_URL); ?>">
                                    </div>
...
<?php echo $__env->make('admin.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customstegpearl/public_html/root/resources/views/admin/settings/payment-gatway/edit.blade.php ENDPATH**/ ?>